...
const DocItem = Vue.component('doc-item', {
  template: ` <div :id="element"> <li class="docItemContainer"> <code v-if="code" class="codeblock"> {{ code }}</code> <div class="desc"> <p>{{ bullet }}</p> </div> <img v-if="gif" class="gif" :src="gif" :alt="element" /> </li> </div>`,
  name: 'doc-item',
  props: ['element', 'bullet', 'code', 'gif'],
});
const DocNav = Vue.component('doc-item', {
  template: ` <a :href="link" class="docnav-element">{{ element }}</a>`,
  name: 'doc-item',
  props: ['element', 'methods', 'link'],
});
const Home = Vue.component('Home', {
  template: ` <div class="home"> <a href="https://github.com/oslabs-beta/vno"> <img id="vnoLogo" src="/assets/vnoLogo.png" /> </a> <h1>A Vue / Deno Adapter</h1> <br /> <div class="logos"> <a href="https://github.com/oslabs-beta/vno" target="_blank"> <img id="gitLogo" src="/assets/git-logo.png" /></a> <a href="https://deno.land/x/vno@v1.0-beta.5" target="_blank"> <img id="denoLogo" src="/assets/deno-logo.png" /></a> </div> </div>`,
  name: 'Home',
  props: { msg: String },
});
const Team = Vue.component('name', {
